...
step_1 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.data_cleaning.data_cleaning.Datacleaning'))
...
step_4 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.classification.svc.SKlearn'))
